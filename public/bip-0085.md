...
[python-bipentropy](https://github.com/ethankosakovsky/bipentropy)

### Other Implementations

Coldcard Firmware: [1](https://github.com/Coldcard/firmware/pull/39)
...
where *app\_no* path for the application, and \`index\` in the index.
